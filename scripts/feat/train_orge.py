"""
Train Ontology-Guided Representation Geometry (ORGE).

ORGE aligns image representations with ontology prototype vectors
...
def main():
    ap = argparse.ArgumentParser(
        description="Train Ontology-Guided Representation Geometry model (ORGE)."
    )
    ...
    # Model
    # --------------------------------------------------
    model = ORGE(args.z_dim, args.hidden_dim).to(device)
    ...
    print(f"[DONE] saved ORGE model to {out_dir}")
